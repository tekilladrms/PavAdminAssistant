...
namespace EmployeeService.Persistence.Repositories
{
    public class EmployeeRepository : IEmployeeRepository
    {
        ...
        public async Task<IEnumerable<Employee>> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            if (employees is null) throw new NotFoundDomainException("no records in database");
        ...
        public async Task<Employee> GetByIdAsync(Guid id, CancellationToken cancellationToken = default)
        {
            ...
            if (employee is null) throw new NotFoundDomainException($"Record with Id = {id} is not exist");
        ...
        public void Delete(Guid id, CancellationToken cancellationToken = default)
        {
            ...
            if (emp is null) throw new NotFoundDomainException($"Record with Id = {id} is not exist");
